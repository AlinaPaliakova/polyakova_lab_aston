...
public class MtsByTest {
    public static void main(String[] args) {
        System.setProperty("webdriver.chrome.driver",
                "C:\\Users\\Admin\\IdeaProjects\\polyakova_aston_lab\\src\\test\\java\\chromedriver.exe");
    ...
    public static void checkContinueButtonOnlyEmail(WebDriver driver) {
        ...
        emailField.sendKeys("alina.polyakova@example.com");
        WebElement continueButton = driver.findElement(By.xpath("//form[@id='pay-connection']//button[@type='submit']"));
        continueButton.click();
